...
class _MapPageState extends State<MapPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text('QR Geolocation'), actions: <Widget>[
        IconButton(
  ...
  Widget _createFlutterMap(ScanModel scan) {
    return new FlutterMap(
      ...
      layers: [_createMap(), _createMarks(scan)],
    );
  }
  ...
  _createMap() {
    return TileLayerOptions(
        ...
        additionalOptions: {
          'accessToken':
              'pk.eyJ1IjoidHJhaWxibGF6ZXJzLWpob255dmlkYWwiLCJhIjoiY2tiZ3NqYzA3MThtZTJvbXVpdjA5NXVpbCJ9.AJuhjHqVqF49bO6JAqEpfg',
          'id': '$typeStyleMap'
        });
  }
